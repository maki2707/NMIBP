...
require(["jquery"], function ($) {
    ...
    function UISearch(el, options) {
        this.el = el;
        this.inputEl = el.querySelector('.sb-search-input');
        this._initEvents();
    }
    ...
    UISearch.prototype = {
        _initEvents: function () {
            ...
            this.inputEl.addEventListener('keypress', function (ev) {
                if (ev.keyCode === 13) {
                    DoSearch(this);
                }
            });
...
require(["jquery", "mobile-searchbar"], function ($) {
